                        ...
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation"
                            ...
                            <div class="form-floating mb-3">
                                <input id="password" type="password"
                                    ...
                                    name="password" required="" autocomplete="new-password" style="border-radius: 35px">
                            ...
                            <button class="btn btn-primary w-75 text-uppercase" type="submit"
                                style="border-radius: 35px; margin-left: 65px;">Register</button>
